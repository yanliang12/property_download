...
today_folder_property_page = '/data/dubizzle/page_html/source=%s'%(today)
today_folder_property_list_page = '/data/dubizzle/page_list_html/source=%s'%(today)
...
page = pandas.read_json(
	'/data/dubizzle/page_list_html/source=date202110/4d0e35d8f7933c4b8bd6410cbb975dd6.json',
	lines = True, 
	orient = 'records',
	)
